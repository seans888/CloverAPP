...
import com.refresh.CloverApp.domain.inventory.ProductLot;
import com.refresh.CloverApp.domain.inventory.Stock;
			...
			public void onClick(View arg0) {
				if (quantityBox.getText().toString().equals("") || costBox.getText().toString().equals("")) {
					Toast.makeText(ProductDetailActivity.this,
							...
							.show();
//				}else if(Integer.parseInt(String.valueOf(quantityBox.getText())) <= 15){
//					Toast.makeText(ProductDetailActivity.this, res.getString(R.string.reorder), Toast.LENGTH_SHORT).show();
				}else {
